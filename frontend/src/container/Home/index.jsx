  ...
  return <div className={s.home}>
    <div className={s.header}>
      <div className={s.dataWrap}>
        <span className={s.expense}>Total Expense: <b>$ { totalExpense }</b></span>
        <span className={s.income}>Total Income: <b>$ { totalIncome }</b></span>
      </div>
      <div className={s.typeWrap}>
        <div className={s.left} onClick={toggle}>
          <span className={s.title}>{ currentSelect.name || 'All Categories' } <Icon className={s.arrow} type="arrow-bottom" /></span>
        </div>
